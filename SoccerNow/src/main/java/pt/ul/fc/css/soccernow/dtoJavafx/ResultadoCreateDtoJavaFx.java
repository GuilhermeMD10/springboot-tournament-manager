...
public class ResultadoCreateDtoJavaFx {

    private Long equipa_titular_vencedora; //ID da equipa
    ...
    public ResultadoCreateDtoJavaFx(){}

    public ResultadoCreateDtoJavaFx(Long vencedor,List<Long> golosVisitado, List<Long> golosVisitante,
                 List<Long> amarelosVisitado, List<Long> amarelosVisitante,
                 List<Long> vermelhosVisitado,List<Long> vermelhosVisitante) {
        this.equipa_titular_vencedora = vencedor;
    ...
    public Long getVencedor() {
        return equipa_titular_vencedora;
    }
