...
public class EquipaService {
     ...
     * @return the equipa dto
     */
    public EquipaDto procurarPorId(Long id) {
        validarId(id);
     ...
     * @return the list
     */
    public List<EquipaDto> procurarPorNome(String nome) {
    ...
    public boolean eliminarPorId(Long id) {
        ...
        //verificar se equipa tem jogos planeados
        ...
        for (EquipaTitular titular : titulares) {
            List<Jogo> jogos = jogoRepository.findByEquipaTitularVisitadaIdOrEquipaTitularVisitanteId(titular.getId(),titular.getId());
            for (Jogo jogo : jogos) {
                if(jogo.getResultado() == null){
                    new RuntimeException("Equipa ainda tem jogos marcados");
                    return false;
                }
            }
            for (Jogo jogo : jogos) {
                if(jogo.getEquipaTitularVisitada().getId() == titular.getId()){
     ...
     * @return the equipa dto
     */
    public EquipaDto atualizarNome(Long id, String novoNome) {
        validarId(id);
    ...
    public EquipaDto adicionaJogador(Long jogadorId, Long equipaId) {
    ...
    public EquipaDto removeJogador(Long jogadorId, Long id) {
        if (id == null || id <= 0) {
            throw new IllegalArgumentException("O id da equipa não é válido.");
        }
        Optional<Equipa> equipaOptional = equipaRepository.findById(id);
        ...
        jogadorRepository.save(jogador);
        equipaRepository.save(equipa);
        EquipaDto equipaDto = mapToDto(equipa);
        return equipaDto;
    }

    public List<EquipaDto> procurarPorNomeJogador(Long id) {
        if (id == null || id <= 0) {
    ...
    public List<EquipaDto> getEquipasComXJogadoresOuMais(Long x) {
    ...
    public List<EquipaDto> getEquipasComXJogadoresOuMenos(Long x) {
        List<Equipa> equipas = equipaRepository.findAll();
    ...
    public List<EquipaDto> getEquipasComXJogadores(Long x) {
        List<Equipa> equipas = equipaRepository.findAll();
    ...
    public List<EquipaDto> getTop5EquipasMaisVitorias() {
    ...
    public List<EquipaDto> getEquipasXVitorias(Long x) {
    ...
    public List<EquipaDto> getEquipasXDerrotas(Long x) {
    ...
    public List<EquipaDto> getEquipasXEmpates(Long x) {
    ...
    public List<EquipaDto> getEquipasSemPos(String pos) {
        ...
        List<EquipaDto> equipasSemPos = new ArrayList<>();
    ...
    public List<EquipaDto> getEquipasConquista(String campNome) {
        ...
        List<EquipaDto> returned = new ArrayList<>();
        List<Equipa> equipas = equipaRepository.findAll();
