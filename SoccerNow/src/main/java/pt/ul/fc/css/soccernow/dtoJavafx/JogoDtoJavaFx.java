...
public class JogoDtoJavaFx {
    ...
    public JogoDtoJavaFx(){}

    public JogoDtoJavaFx (Long arbitroPrincipal, List<Long> equipaArbitragem, Long equipaTitularVisitante, Long equipaTitularVisitada,
