...
@Service
public class EquipaTitularService {
    ...
    /**
     * Converte um objeto{@link EquipaTitular} para um {@link EquipaTitularDto}.
     * 
     * @param equipaTitular a equipaTitular a ser convertida
     * @return o DTO correspondente ah equipa titular fornecida
     */
    public EquipaTitularDto mapToDto(EquipaTitular equipaTitular){
        EquipaTitularDto equipaTitularDto = new EquipaTitularDto();
        equipaTitularDto.setId(equipaTitular.getId());
        equipaTitularDto.setEquipa(equipaService.mapToDto(equipaTitular.getEquipa()));
        List<JogadorDto> jogadoresDtos = equipaTitular.getJogadores().stream().map(jogador -> jogadorService.mapToDto(jogador))
            .collect(Collectors.toList());
        equipaTitularDto.setJogadores(jogadoresDtos);
        equipaTitularDto.setGuardaRedes(jogadorService.mapToDto(equipaTitular.getGuardaRedes()));
        return equipaTitularDto;
    }

    /**
     * Cria uma nova equipa titular com base num {@link EquipaTitularDto}.
     *
     ...
     */
    public EquipaTitularDto createEquipaTitular(EquipaTitularCreateDto equipaTitularDto){
    ...
    public EquipaTitularDto getEquipaTitularById(Long id){
    ...
    public List<EquipaTitularDto> getEquipasTitularesByEquipa(Long equipa_id) {
        return equipaTitularRepository.findByEquipaId(equipa_id)
                    .stream().map(this::mapToDto).collect(Collectors.toList());
    }

    public EquipaTitularDto saveEquipaTitular(EquipaTitular equipaTitular){
        return mapToDto(equipaTitularRepository.save(equipaTitular));
    }

    public List<EquipaTitularDto> getAllEquipaTitular() {
