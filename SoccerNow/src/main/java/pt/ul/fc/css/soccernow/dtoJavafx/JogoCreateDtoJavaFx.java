...
public class JogoCreateDtoJavaFx {
    ...
    public JogoCreateDtoJavaFx(){}

    public JogoCreateDtoJavaFx (Long arbitroPrincipal, List<Long> equipaArbitragem, Long equipaTitularVisitante, Long equipaTitularVisitada,
