 ...
 */
@Service
public class UtilizadorServiceJavaFx {
    ...
    /**
     * Converte um objeto {@link Utilizador} para um {@link UtilizadorDtoJavaFx}.
     *
     * @param utilizador o utilizador a ser convertido
     * @return o DTO correspondente ao utilizador fornecido
     */
    private UtilizadorDtoJavaFx mapToDto(Utilizador utilizador){
        UtilizadorDtoJavaFx utilizadorDto = new UtilizadorDtoJavaFx();
    ...
    /**
     * Cria um novo utilizador com base num {@link UtilizadorDtoJavaFx}.
     *
     ...
     */
    public UtilizadorDtoJavaFx createUtilizador(UtilizadorDtoCreate utilizadorDtoCreate){
        ...
        UtilizadorDtoJavaFx utilizadorDto = this.mapToDto(savedUtilizador);
        return utilizadorDto;
    }
     ...
     */
    public UtilizadorDtoJavaFx saveUtilizador(Utilizador utilizador) {
        if(utilizador == null){
    ...
    public UtilizadorDtoJavaFx updateUtilizador (UtilizadorDtoJavaFx utilizadorDto){
        ...
        Utilizador savedUtilizador = utilizadorRepository.save(utilizador);
        UtilizadorDtoJavaFx utilizadorDtoSaved = this.mapToDto(savedUtilizador);
...
//----------------------------FUNCOES PARA PROCURAR UTILIZADORES----------------------------//
    ...
    public UtilizadorDtoJavaFx procurarPorNif(String nif) {
    ...
    public UtilizadorDtoJavaFx procurarPorEmail(String email) {
     ...
     */
    public UtilizadorDtoJavaFx procurarPorId(Long id) {
        validarId(id);
        Optional<Utilizador> utilizadorOptional = utilizadorRepository.findById(id);
        if (utilizadorOptional.isEmpty()){
            throw new RuntimeException("Utilizador não encontrado");
     ...
     *
     * @return lista de {@link UtilizadorDtoJavaFx} com todos os utilizadores
     */
    public List<UtilizadorDtoJavaFx> getTodosUtilizadores() {
     ...
     */
    public List<UtilizadorDtoJavaFx> procurarPorNome(String nome) {
...
//----------------------------FUNCOES PARA UPDATE UTILIZADORES----------------------------//
     ...
     * @throws RuntimeException se o utilizador não for encontrado
     */
    public UtilizadorDtoJavaFx atualizarNome(Long id, String novoNome) {
        validarId(id);
