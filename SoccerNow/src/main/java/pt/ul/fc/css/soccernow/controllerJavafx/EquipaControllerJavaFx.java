...
import pt.ul.fc.css.soccernow.serviceJavafx.EquipaServiceJavaFx;


@RestController
@RequestMapping("/apiJavafx/equipas")
@Tag(name = "Equipas", description = "Endpoints para gestão de equipas")

public class EquipaControllerJavaFx {
    ...
    public ResponseEntity<EquipaDtoJavaFx> criarEquipa(@RequestBody EquipaDtoJavaFx equipaDto) {
        EquipaDtoJavaFx equipaCriada = equipaService.createEquipa(equipaDto);   
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarTodos() {
    ...
    public ResponseEntity<EquipaDtoJavaFx> procurarPorId(@PathVariable Long id) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> procurarPorNome(@RequestParam String nome) {
        return ResponseEntity.ok(equipaService.procurarPorNome(nome));
    }

    @GetMapping("/searchJogador")
    @Operation(summary = "Procurar equipa por id")
    public ResponseEntity<List<EquipaDtoJavaFx>> procurarPorNomeJogador(@RequestParam Long id) {
    ...
    public ResponseEntity<EquipaDtoJavaFx> atualizarNome(
    ...
    public ResponseEntity<EquipaDtoJavaFx> adicionarJogador(
            @PathVariable Long id,
    ...
    public ResponseEntity<EquipaDtoJavaFx> removerJogador(
            @PathVariable Long id,
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasComXJogadoresOuMais(@RequestParam Long x) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasComXJogadoresOuMenos(@RequestParam Long x) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasComXJogadores(@RequestParam Long x) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasMaisVitorias(@RequestParam Long x) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasXVitorias(@RequestParam Long x) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasXDerrotas(@RequestParam Long x) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasXEmpates(@RequestParam Long x) {
    ...
    */
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipaConquista(@RequestParam String campNome) {
    ...
    public ResponseEntity<List<EquipaDtoJavaFx>> listarEquipasSemPos(@RequestParam String pos) {
