...
public class CampeonatoDtoJavaFx {
    ...
    public CampeonatoDtoJavaFx(List<Long> equipas, String nome) {
        this.equipas = equipas;
        this.nome = nome;
        this.classificacao = new ArrayList<>();
        this.jogos = new ArrayList<>();
    }
    public CampeonatoDtoJavaFx() {
        this.nome = "";
    ...
    public CampeonatoDtoJavaFx(String nome) {
        this.nome = nome;
        this.equipas = new ArrayList<>();
        this.classificacao = new ArrayList<>();
        this.jogos = new ArrayList<>();
